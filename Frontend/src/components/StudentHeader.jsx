...
export function StudentHeader({ userdata, onToggleSidebar, handleMouseEnter, handleMouseLeave, collegeData }) {
    ...
    return (
        <header className="h-16 flex items-center justify-between px-2 lg:px-4 shrink-0 z-50 border-b border-white/20 shadow-sm bg-white/70 backdrop-blur-md sticky top-0">
