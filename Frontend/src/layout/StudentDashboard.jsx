...
export function StudentDashboard() {
    ...
    return (
        <div className="">
            ...
            {!filters.loading && !filters.refresh && !filters.navigate.status && user && collegeData &&
                <div className="bg-gray-50 flex flex-col h-screen overflow-hidden font-body relative">
                    ...
                    <div className="flex flex-1 overflow-hidden relative">
                        ...
                        {/* MAIN CONTENT AREA: ml-0 applied everywhere below lg (1024px) so it hovers. lg:ml-20 or lg:ml-60 applied to take space on desktop */}
                        <main className={`flex flex-col flex-1 h-full w-full overflow-hidden transition-all duration-300 ml-0 ${uiState?.isSidebarCollapsed ? "sm:ml-20" : "lg:ml-60"}`}>
                            <div className="flex-1 overflow-y-auto flex flex-col bg-slate-50/50 dot-grid relative">
                                <div className="flex-1 container mx-auto p-4 sm:p-6 lg:p-8 max-w-[1600px] w-full z-10">
